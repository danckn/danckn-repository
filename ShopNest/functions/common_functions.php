    ...
    if(!isset($_GET['category'])){
      if(!isset($_GET['brand'])){
        ...
        while($row=mysqli_fetch_assoc($result_query)){
          ...
          <div class='card'>
                      <img src='./admin_area/product_images/$product_image1' class='product_img' alt='$product_title'>
                      <div class='card-body'>
...
function showcategories() {
  ...
  $select_query = "SELECT * FROM `categories` ORDER BY RAND() LIMIT 0, 9";
  ...
  if ($result_query) {
      while ($row = mysqli_fetch_assoc($result_query)) {
          ...
          echo "<div class='col-md-4 mb-2'>
                  <div class='card'>
                      <img src='./admin_area/category_images/$category_image' class='category_img' alt='$category_title'>
                      <div class='card-body'>
                          <h5 class='card-title'>$category_title</h5>
                          <a href='product_details.php?category_id=$category_id' class='btn btn-secondary'>View more</a>
                      </div>
                  </div>
                </div>";
      }
      ...
      // Handle query error
      echo "<p>Error retrieving categories: " . mysqli_error($con) . "</p>";
  }
}
